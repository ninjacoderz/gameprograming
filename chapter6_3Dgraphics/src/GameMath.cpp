...
const Vector3 Vector3::Infinity(GameMath::Infinity, GameMath::Infinity, GameMath::Infinity);
const Vector3 Vector3::NegInfinity(GameMath::NegInfinity, GameMath::NegInfinity, GameMath::NegInfinity);
...
Vector3 Vector3::TransformWithPerspDiv(const Vector3& vec, const Matrix4& mat, float w /*= 1.0f*/)
{
	...
	if (!GameMath::NearZero(GameMath::Abs(transformedW)))
	{
